...
//This is what I suspect isn't working. it doesn't produce an error message, but nothing within it is useable
// use PhpmlExercise\Classification\SentimentAnalysis; 

// 3-17-18 LETS SEE WHAT WE CAN DO ABOUT CONVERTING THIS PYTHON BACK INTO PHP...

// use Phpml\Dataset\CsvDataset;   //LETS NOT TAKE OUR FILES SO DEEP. MOVING A COPY TO A CLOSER LOCATION TO ROOT --NEVERMIND. WE'LL WORRY ABOUT THAT LATER
// use Phpml\Dataset\ArrayDataset;

// use phpml\Dataset\CsvDataset;
// use phpml\Dataset\ArrayDataset;

//the autoloader, which I have checked to make sure it does exist in that location
...
// SO DO WE REALLY HAVE TO DECLARE A CLASS JUST TO USE A TOSTRING METHOD??? IS THIS REAL??
// class StringMaker
// {
    // public $foo;
